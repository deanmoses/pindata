...
The shift to LCD screens brought pinball into the HD era. Where a [[displaysubtype:plasma-dmd]] offered 128×32 pixels in a single orange color, a modern LCD backbox display runs at 1920×1080 or higher, capable of playing back video footage, layered animation, and real-time rendered graphics indistinguishable from a console game. [[manufacturer:jersey-jack]]'s *[[title:the-wizard-of-oz]]* (2013) demonstrated what was possible; within a few years, large-format LCD panels had become the industry standard.
