...
A configuration in which no coin is required to start a game. The player presses the start button and plays without payment. Free play is not a reward mechanism in the same sense as [[rewardtype:replay]] or [[rewardtype:add-a-ball]] — it is the absence of the coin-operated transaction entirely.
