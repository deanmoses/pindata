...
Seven-segment displays could show numbers cleanly but struggled with text. Designers worked around the limitation by using the backglass artwork and playfield inserts to communicate everything that wasn't a score. By the early 1980s, [[display-subtype:16-segment]] alphanumeric displays had arrived, capable of rendering readable text, and seven-segment panels were phased out of new designs within a few years.
